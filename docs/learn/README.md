...
| 7 · Production bring-up, footer, sandbox delete | — | **Operational readiness.** Exactly one environment firing at night, budgets, teardown date in the README, runbooks. An intentional ending is a feature. |
